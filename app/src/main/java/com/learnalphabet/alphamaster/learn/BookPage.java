...
public class BookPage {
	 ...
	 * Setter for textures.
	 */
	public void setTexture(Bitmap texture, int side,int index) {
		String[] toSpeaktry = {"","","A for Apple","", "B for Ball","", "C for Cat",""};
		if (texture == null) {
		...
		case SIDE_FRONT:
			...
			//mCurl.ttobj.speak(toSpeakletterword[index], TextToSpeech.QUEUE_FLUSH, null);
			break;
		case SIDE_BACK:
			if (mTextureBack != null)
				mTextureBack.recycle();
